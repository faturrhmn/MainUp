                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="nomor_aset" name="nomor_aset" value="{{ $asset->nomor_aset }}" min="0">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="tipe" name="tipe" required>
                                            ...
                                            <option value="habispakai" {{ old('tipe', $asset->tipe) == 'habispakai' ? 'selected' : '' }}>Habis Pakai</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
